...
So here comes [[KL Divergence]], if we Taylor expand that, we'll see the first two terms are all 0, and it can be approximated just by the second term, the [[Fisher information]] matrix, and it's the Reimannian metric on the manifold of probability distributions. 
